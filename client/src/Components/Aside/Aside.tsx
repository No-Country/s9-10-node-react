        ...
        <div className='mb-32'>
          ...
          <Link
            ...
            className={`flex items-center gap-x-2 text-lg border-l-4 border-greyPrimary2 border-x-greyPrimary2 py-2 px-3 ${
              activeLink === '/user' ? 'bg-azulClaroBg !border-bluePrimary text-azulSecundary' : ''
            }`}
          >
            <div className={`bg-greyPrimary1 p-2 rounded-full ${activeLink === '/user' ? '!bg-bluePrimary text-white' : ''}`}>
              <LuLayoutDashboard />
            </div>
            Dashboard
          </Link>
          ...
          <Link
            ...
            className={`flex items-center gap-x-2 text-lg border-l-4 border-greyPrimary2 py-2 px-3 ${
              activeLink === '/user/ranking-rol' ? 'bg-azulClaroBg !border-bluePrimary text-azulSecundary' : ''
            }`}
          >
            <div className={`bg-greyPrimary1 p-2 rounded-full ${activeLink === '/user/ranking-rol' ? '!bg-bluePrimary text-white' : ''}`}>
              <BsPersonVcard />
            </div>
            Administrar Roles
          </Link>
          ...
          <Link
            ...
            className={`flex items-center gap-x-2 text-lg border-l-4 border-greyPrimary2 py-2 px-3 ${
              activeLink === '/user/crear-equipos' ? 'bg-azulClaroBg !border-azulPrimary text-azulSecundary' : ''
            }`}
            onClick={() => handleNavLinkClick('/user/crear-equipos')}
          >
            <div className={`bg-greyPrimary1 p-2 rounded-full ${activeLink === '/user/ranking-equipos' ? '!bg-bluePrimary text-white' : ''}`}>
              <FaPeopleGroup />
            </div>
          ...
          <div>
            {isOpen && (
              <div className='flex flex-col pl-14 border-l-2 text-sm'>
                {equipos.map(equipo => {
                  return <Link to={'/user'} className='py-2'>{equipo}</Link>;
                })}
              </div>
            )}
          </div>
          ...
          <Link
            ...
            className={`flex items-center justify-between gap-x-2 text-lg border-l-4 border-greyPrimary2 py-2 px-3 ${
              activeLink === '/user/forms' ? 'bg-azulClaroBg !border-bluePrimary text-azulSecundary' : ''
            }`}
          >
            <div className='flex gap-x-2'>
              {/* ----- Icon */}
              <div className={`bg-greyPrimary1 p-2 rounded-full ${activeLink === '/user/forms' ? '!bg-bluePrimary text-white' : ''}`}>
                <TbNotes />
              </div>
              {/* ----- Link */}
              Formularios
          ...
          <Link
            ...
            className={`flex items-center gap-x-2 text-lg border-l-4 border-greyPrimary2 py-2 px-3 ${
              activeLink === '/user/profile' ? 'bg-azulClaroBg !border-bluePrimary text-azulSecundary' : ''
            }`}
          >
            <div className={`bg-greyPrimary1 p-2 rounded-full ${activeLink === '/user/profile' ? '!bg-bluePrimary text-white' : ''}`}>
              <GoPerson />
            </div>
            Perfil
          </Link>
